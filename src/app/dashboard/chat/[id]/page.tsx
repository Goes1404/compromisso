    ...
    <div className="flex flex-col h-full bg-slate-50 animate-in fade-in overflow-hidden">
      ...
      <div className="flex-1 min-h-0 flex flex-col relative">
        ...
        <div className="p-4 md:p-8 bg-white border-t shrink-0">
          <form onSubmit={handleSend} className="flex items-center gap-4 max-w-4xl mx-auto bg-slate-100 p-2 pl-8 rounded-[2.5rem] border border-slate-200 focus-within:ring-4 focus-within:ring-accent/10 transition-all">
             <Input 
              value={input}
